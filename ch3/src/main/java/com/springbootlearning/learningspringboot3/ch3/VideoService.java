...
@Service public class VideoService {
  ...
  public List<VideoEntity> search(VideoSearch videoSearch) {
    if (StringUtils.hasText(videoSearch.name()) //
      ...
      return repository //
        .findByNameContainingOrDescriptionContainingAllIgnoreCase(videoSearch.name(), videoSearch.description());
    }
  ...
  @PostConstruct void initDatabase() {
